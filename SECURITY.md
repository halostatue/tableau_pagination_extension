# TableauPaginationExtension Security
...
TableauPaginationExtension supports at most the three most recent versions
of Elixir and supported [Erlang/OTP versions][otp-versions].
