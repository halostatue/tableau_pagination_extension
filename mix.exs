defmodule TableauPaginationExtension.MixProject do
  use Mix.Project

  @app :tableau_pagination_extension
  @project_url "https://github.com/halostatue/tableau_pagination_extension"
  @version "1.0.0"

  def project do
    [
      app: @app,
      description: "A Tableau extension for paginating collection indexes",
      version: @version,
      source_url: @project_url,
      name: "TableauPaginationExtension",
      elixir: "~> 1.18",
  ...
  defp docs do
    [
      main: "TableauPaginationExtension",
      extras: [
        "README.md",
        "guides/paginating-tags.md": [
          filename: "paginating-tags",
          title: "Paginating Tags"
        ],
